...
<section class="checkout-orders">
   ...
   <?php
      ...
      <div class="flex">
         <div class="inputBox">
            <span>Your name :</span>
            <input type="text" name="name" placeholder="enter your name" maxlength="20" class="box" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>State :</span>
            <input type="text" name="state" placeholder="e.g. thiruvallur" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
